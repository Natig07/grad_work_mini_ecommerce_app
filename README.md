...
A Next.js 14+ application demonstrating the performance differences between **Client-Side Rendering (CSR)** and **Edge Rendering** with real product data from an external API.

## Features

- 🎯 **Two Rendering Strategies**: Compare CSR and Edge rendering side-by-side
...
5. Compare across both rendering strategies
...
2. **Edge** offers the best TTFB and is ideal for global performance
3. Real-world choice depends on your specific use case and audience distribution
4. Network conditions dramatically affect these metrics (test with throttling)
