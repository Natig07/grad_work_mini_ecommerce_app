...
async function getProduct(id: string): Promise<Product | null> {
  console.log('[SSR] Product fetch started at:', new Date().toISOString());
  ...
  try {
    ...
    console.log(`[SSR] Product fetch completed in ${endTime - startTime}ms`);
...
export default async function SSRProductPage({ params }: PageProps) {
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 py-8">
          <Link href="/ssr/products" className="text-blue-600 hover:text-blue-800 mb-4 inline-flex items-center gap-2">
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <Link href="/ssr/products" className="text-blue-600 hover:text-blue-800 mb-8 inline-flex items-center gap-2">
          <ArrowLeft className="w-4 h-4" />
          Back to Products
        </Link>
            ...
            <div>
              ...
              <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                <p className="text-sm text-green-800">
                  ...
                  <br />
                  This product was fetched and rendered on the server before sending to the browser.
                </p>
              </div>
            </div>
          </div>
